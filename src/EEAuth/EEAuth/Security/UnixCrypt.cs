...
namespace EEAuth.Security
{
    ...
    /// </summary>
    /// <remarks>
    ///     This class is a port from Java source. I do not understand the underlying algorithms, I just converted it to C# and
    ///     it works.
    ///     Because I do not understand the underlying algorithms I cannot give most of the variables useful names. I have no
    ///     clue what their
    ///     significance is. I tried to give the variable names as much meaning as possible, but the original source just
    ///     called them a, b, c , etc...
    ///     A very important thing to note is that all ints in this code are UNSIGNED ints! Do not change this, ever!!! It will
    ///     seriously fuckup the working
    ///     of this class. It uses major bitshifting and while Java gives you the >>> operator to signify a right bitshift
    ///     WITHOUT setting the MSB for
    ///     a signed int, C# does not have this operator and will just set the new MSB for you if it happened to be set the
    ///     moment you bitshifted it.
    ///     This is undesirable for most bitshifts and in the cases it did matter, I casted the variable back to an int. This
    ///     was only required where
    ...
    public static class UnixCrypt
    {
        ...
        private static uint DEncrypt(uint left, uint right, uint scheduleIndex, uint firstSaltTranslator,
            uint secondSaltTranslator, uint[] schedule)
        {
        ...
        /// <summary>
        ///     Automatically generate the encryption salt (2 random printable characters for use in the encryption) and call the
        ///     Crypt() method.
        /// </summary>
